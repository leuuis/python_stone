...
def battle(list_a, list_b):
    ...
    sum_list_b = sum(list_b)

    return f"puntos {sum_list_a} - {sum_list_b} and the winner is list_a!" if sum_list_a > sum_list_b else f"puntos {sum_list_b} - {sum_list_a} and the winner is list_b!" if sum_list_b > sum_list_a else "x"
