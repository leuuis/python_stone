...
def check_is_balanced(text):
    ...
    # contar facilmente el número de veces que aparece un aletra
    count_r = text.count("R")
    count_j = text.count("J")

    print(f"count_r {count_r}, count_j {count_r}")
...
print(check_is_balanced("RRRRRRJJ"))
print(check_is_balanced("RRRRRaRJJ"))
