...
# .group() devuleve la cadena que coincide con el pattern
print(result.group())

# .start() devolver la posición inicial de la coincidencia
print(result.start())

# .start() devolver la posición final de la coincidencia
print(result.end())
...
found_python = re.findall(pattern, text, flags=re.IGNORECASE)
